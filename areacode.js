...
function compactWall(instant, zone) {
  ...
  function setupCompactConverter() {
    ...
    tool.innerHTML = `<div class="cc-location"><label for="cc-from">From</label><div class="cc-search"><input id="cc-from" type="text" value="" placeholder="Enter city" autocomplete="off" role="combobox" aria-autocomplete="list" aria-expanded="false" aria-controls="cc-from-options"><div id="cc-from-options" class="cc-options" role="listbox" aria-label="From locations" hidden></div></div></div>
      <div class="cc-location" style="margin-top:4px"><label for="cc-time">Time</label><input id="cc-time" type="time" value="" autocomplete="off" step="60" aria-label="Time in From location" style="max-width:130px"></div>
      <div class="cc-swap-row"><button id="cc-swap" type="button" aria-label="Swap locations" title="Swap locations">⇅</button></div>
      <div class="cc-location"><label for="cc-to">To</label><div class="cc-search"><input id="cc-to" type="text" value="" placeholder="Enter city" autocomplete="off" role="combobox" aria-autocomplete="list" aria-expanded="false" aria-controls="cc-to-options"><div id="cc-to-options" class="cc-options" role="listbox" aria-label="To locations" hidden></div></div></div>
      <div class="cc-location" style="margin-top:4px"><span>Time</span><div class="cc-answer" aria-label="Time in To location" aria-live="polite"><strong id="cc-result">—</strong><span id="cc-day"></span></div></div>
